...
const (
	...
	LedgerService_GetLedgerHistory_FullMethodName = "/ledger.LedgerService/GetLedgerHistory"
)
...
type LedgerServiceClient interface {
	...
	GetLedgerHistory(ctx context.Context, in *GetLedgerHistoryRequest, opts ...grpc.CallOption) (*GetLedgerHistoryResponse, error)
}
...
func (c *ledgerServiceClient) GetLedgerHistory(ctx context.Context, in *GetLedgerHistoryRequest, opts ...grpc.CallOption) (*GetLedgerHistoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetLedgerHistoryResponse)
	err := c.cc.Invoke(ctx, LedgerService_GetLedgerHistory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LedgerServiceServer interface {
	...
	GetLedgerHistory(context.Context, *GetLedgerHistoryRequest) (*GetLedgerHistoryResponse, error)
...
func (UnimplementedLedgerServiceServer) GetLedgerHistory(context.Context, *GetLedgerHistoryRequest) (*GetLedgerHistoryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetLedgerHistory not implemented")
}
...
func _LedgerService_GetLedgerHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetLedgerHistoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LedgerServiceServer).GetLedgerHistory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LedgerService_GetLedgerHistory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LedgerServiceServer).GetLedgerHistory(ctx, req.(*GetLedgerHistoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LedgerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetLedgerHistory",
			Handler:    _LedgerService_GetLedgerHistory_Handler,
		},
	},
